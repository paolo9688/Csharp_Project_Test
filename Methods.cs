public class Methods
{
    ...
    public bool CheckDouble(int roll1, int roll2, int roll3, bool bonus)
    {
    ...
    public bool CheckTriple(int roll1, int roll2, int roll3)
    {
    ...
    public void CheckResults(int total)
    {
        if (total > 14)
        {
